...
const SingleProject = ({ project }: { project: Project }) => {
  return (
    <a
      href={project.link}
      target="_blank"
      className="block p-5 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 relative"
    >
      <h3 className="text-2xl font-medium pb-1 text-gray-800">
        {project.name}
      </h3>
      <p className="py-2 text-gray-500 leading-7 text-base">{project.desc}</p>

      <svg
        className="w-8 h-8 rotate-180 ml-auto absolute bottom-2 right-4"
        viewBox="0 0 24 24"
        fill="none"
